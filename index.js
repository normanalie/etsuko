...
const client = new Client({
    ...
    partials: [
        Partials.Channel, Partials.Message, Partials.Reaction, Partials.User, Partials.GuildMember
    ],
    intents: [
    ...
    switch(messageReaction.message.channel.id) {
        case "884497820743237692":
            switch(messageReaction.emoji.name) {
                case "📖":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "CPI 1")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "CPI 1");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;

                case "📚":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "CPI 2")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "CPI 2");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🧑‍🔧":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "MT 3")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "MT 3");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🦿":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "MT 4")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "MT 4");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🦾":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "MT 5")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "MT 5");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🧑‍💻":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "IATIC 3")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "IATIC 3");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🖥️":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "IATIC 4")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "IATIC 4");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "💻":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "IATIC 5")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "IATIC 5");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "💡":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "SEE 3")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "SEE 3");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "📡":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "SEE 4")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "SEE 4");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🛰️":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "SEE 5")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "SEE 5");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🧑‍🏭":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "SNPI 3")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "SNPI 3");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🤖":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "SNPI 4")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "SNPI 4");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🏭":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "SNPI 5")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "SNPI 5");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🌍":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "M1 IRS")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "M1 IRS");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🌑":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "M2 IRS")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "M2 IRS");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🔥":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "M1 CHPS")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "M1 CHPS");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "💥":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "M2 CHPS")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "M2 CHPS");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    etud = true;
                    break;
                ...
                case "🧑‍🦳":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "Anciens étudiants")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "Anciens étudiants");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    if(messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "Filière non choisie")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "Filière non choisie");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.remove(role.id);
                    }
                    break;

                case "🧑‍🌾":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "Squatteur/Plébéien")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "Squatteur/Plébéien");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    if(messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "Filière non choisie")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "Filière non choisie");
            ...
            if(etud) {
                if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "Étudiant")) {
                    role = messageReaction.message.guild.roles.cache.find(r => r.name === "Étudiant");
                    messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                }
                if(messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "Filière non choisie")) {
                    role = messageReaction.message.guild.roles.cache.find(r => r.name === "Filière non choisie");
        ...
        case "884498054466666587":
            switch(messageReaction.emoji.name) {
                case "🇩🇪":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.id === allemandCpi2)) {
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(allemandCpi2);
                    }
                    break;
            
                case "🇪🇸":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.id === espagnolCpi2)) {
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(espagnolCpi2);
                    }
                    break;
        ...
        case "884498154794414080":
            switch(messageReaction.emoji.name) {
                case "🇩🇪":
                    if(messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "IATIC 3")) {
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(allemandIatic3);
                    }
                    if(messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "IATIC 4")) {
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(allemandIatic4);
                    }
                    break;
            
                case "🇪🇸":
                    if(messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "IATIC 3")) {
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(espagnolIatic3);
                    }
                    if(messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "IATIC 4")) {
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(espagnolIatic4);
                    }
                    break;

                case "🇨🇳":
                    if(messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "IATIC 3")) {
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(chinoisIatic3);
                    }
                    if(messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "IATIC 4")) {
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(chinoisIatic4);
                    }
                    break;
        ...
        case "884842022589050900":
            switch(messageReaction.emoji.name) {
                case "🎮":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "Gamer")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "Gamer");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    break;
                ...
                case "🛋️":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "Détente")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "Détente");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    break;
        ...
        case "886387568093065226":
            switch(messageReaction.emoji.name) {
                case "🧐":
                    if(!messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== messageReaction.message.guild.id).find(r => r.name === "Monocle de Vérité")) {
                        role = messageReaction.message.guild.roles.cache.find(r => r.name === "Monocle de Vérité");
                        messageReaction.message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
                    }
                    break;
        ...
        case "884834854615785522":
            switch(messageReaction.emoji.name) {
                case "🔄":
                    add_role_by_name(messageReaction.message, user, "Filière non choisie");
                    ...
                    remove_role_by_name(messageReaction.message, user, "IATIC 3");
                    remove_role_by_name(messageReaction.message, user, "IATIC 4");
                    remove_role_by_name(messageReaction.message, user, "IATIC 5");
                    ...
                    remove_role_by_name(messageReaction.message, user, "M1 CHPS");
                    remove_role_by_name(messageReaction.message, user, "M2 CHPS");
                    remove_role_by_name(messageReaction.message, user, "M1 IRS");
                    remove_role_by_name(messageReaction.message, user, "M2 IRS");
                    remove_role_by_name(messageReaction.message, user, "Anciens étudiants");
                    remove_role_by_name(messageReaction.message, user, "Squatteur/Plébéien");
                    remove_role_by_id(messageReaction.message, user, allemandCpi2);
                    remove_role_by_id(messageReaction.message, user, espagnolCpi2);
                    remove_role_by_id(messageReaction.message, user, allemandIatic3);
                    remove_role_by_id(messageReaction.message, user, espagnolIatic3);
                    remove_role_by_id(messageReaction.message, user, chinoisIatic3);
                    remove_role_by_id(messageReaction.message, user, allemandIatic4);
                    remove_role_by_id(messageReaction.message, user, espagnolIatic4);
                    remove_role_by_id(messageReaction.message, user, chinoisIatic4);
                    remove_role_by_name(messageReaction.message, user, "Étudiant");
                    break;
...
function remove_role_by_name(message, user, roleName) {
    if(message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== message.guild.id).find(r => r.name === roleName)) {
        role = message.guild.roles.cache.find(r => r.name === roleName);
        message.guild.members.cache.find(m => m.id === user.id).roles.remove(role.id);
    }
}

function remove_role_by_id(message, user, roleId) {
    if(message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== message.guild.id).find(r => r.id === roleId)) {
        message.guild.members.cache.find(m => m.id === user.id).roles.remove(roleId);
    }
}
...
function add_role_by_name(message, user, roleName) {
    if(!message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== message.guild.id).find(r => r.name === roleName)) {
        role = message.guild.roles.cache.find(r => r.name === roleName);
        message.guild.members.cache.find(m => m.id === user.id).roles.add(role.id);
    }
}

function has_role_by_name(message, user, roleName) {
    return message.guild.members.cache.find(m => m.id === user.id).roles.cache.filter(r => r.id !== message.guild.id).find(r => r.name === roleName);
}

async function change_category_name(message, oldName, newName) {
    let channel = await message.guild.channels.cache.find(c => ((c.name === oldName) && (c.type === "category")));
...
async function create_category(message, roleEve, roleModo, roleMono, roleEtu, name) {
...
async function create_lang_channel(message, roleEve, roleModo, roleMono, roleEtu, name, categoryId, position, roleLang) {
    let channel;
    message.guild.channels.create(name).then(c => {
        c.setParent(categoryId);
        c.setPosition(position);
...
async function create_voice_channel(message, roleEve, roleModo, roleMono, roleEtu, name, categoryId, position) {
    let channel;
...
async function create_complet_category(message, roleEve, roleModo, roleMono, roleEtu, name) {
    let categoryId = await create_category(message, roleEve, roleModo, roleMono, roleEtu, name);
    await create_text_channel(message, roleEve, roleModo, roleMono, roleEtu, "『📰』news", categoryId, 1);
    await create_text_channel(message, roleEve, roleModo, roleMono, roleEtu, "『💭』cours", categoryId, 2);
    await create_text_channel(message, roleEve, roleModo, roleMono, roleEtu, "『📔』agenda", categoryId, 3);
    await create_text_channel(message, roleEve, roleModo, roleMono, roleEtu, "『💯』hors-sujet", categoryId, 4);
    await create_voice_channel(message, roleEve, roleModo, roleMono, roleEtu, "『🔊』Amphi A", categoryId, 1);
    await create_voice_channel(message, roleEve, roleModo, roleMono, roleEtu, "『🔊』Amphi B", categoryId, 2);
    await create_voice_channel(message, roleEve, roleModo, roleMono, roleEtu, "『🔊』Amphi C", categoryId, 3);

    if (name === "IATIC 3") {
        let allemandIatic3Role = await message.guild.roles.cache.find(r => r.id === allemandIatic3);
        if (allemandIatic3Role != undefined)
            await create_lang_channel(message, roleEve, roleModo, roleMono, roleEtu, "『🇩🇪』allemand", categoryId, 3, allemandIatic3Role);
        let espagnolIatic3Role = await message.guild.roles.cache.find(r => r.id === espagnolIatic3);
        if (espagnolIatic3Role != undefined)
            await create_lang_channel(message, roleEve, roleModo, roleMono, roleEtu, "『🇪🇸』espagnol", categoryId, 3, espagnolIatic3Role);
        let chinoisIatic3Role = await message.guild.roles.cache.find(r => r.id === chinoisIatic3);
        if (chinoisIatic3Role != undefined)
            await create_lang_channel(message, roleEve, roleModo, roleMono, roleEtu, "『🇨🇳』chinois", categoryId, 3, chinoisIatic3Role);
    }
}

async function delete_category(message, name) {
    let category = await message.guild.channels.cache.find(c => ((c.name === name) && (c.type === "category")));
...
async function delete_channel_in_category(message, nameChannel, nameCategory) {
    let category = await message.guild.channels.cache.find(c => ((c.name === nameCategory) && (c.type === "category")));
    if (category != undefined) {
        let channel = await message.guild.channels.cache.find(c => ((c.name === nameChannel) && (c.parent === category)));
        if (channel != undefined) {
...
async function create_role(message, name, color) {
    let role;
    await message.guild.roles.create().then(r => {
        role = r;
...
async function get_roles(message) {
    let roleEtu = [];
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "CPI 1"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "CPI 2"));
    ...
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "IATIC 3"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "IATIC 4"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "IATIC 5"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "SEE 3"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "SEE 4"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "SEE 5"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "SNPI 3"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "SNPI 4"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "SNPI 5"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "M1 CHPS"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "M2 CHPS"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "M1 IRS"));
    roleEtu.push(await message.guild.roles.cache.find(r => r.name === "M2 IRS"));
    return roleEtu;
}
...
async function change_all_roles(message) {
    ...
    await change_role_name(message, "IATIC 4", "IATIC 5", color[Etudiants.IATIC5]);
    await change_role_name(message, "IATIC 3", "IATIC 4", color[Etudiants.IATIC4]);
    ...
    await change_role_name(message, "M1 CHPS", "M2 CHPS", color[Etudiants.M2CHPS]);
...
async function change_all_categories(message) {
    ...
    let roleModo = await message.guild.roles.cache.find(r => r.name === "Modo");
    let roleMono = await message.guild.roles.cache.find(r => r.name === "Monocle de Vérité");
    ...
    let cpi2Category = await message.guild.channels.cache.find(c => ((c.name === "CPI 2") && (c.type === "category")));
    let allemandCpi2Role = await message.guild.roles.cache.find(r => r.id === allemandCpi2);
    let espagnolCpi2Role = await message.guild.roles.cache.find(r => r.id === espagnolCpi2);
    if (cpi2Category != undefined) {
        if (allemandCpi2Role != undefined)
            create_lang_channel(message, roleEve, roleModo, roleMono, roleEtu[Etudiants.CPI2], "『🇩🇪』allemand", cpi2Category, 3, allemandCpi2Role);
        if (espagnolCpi2Role != undefined)
            create_lang_channel(message, roleEve, roleModo, roleMono, roleEtu[Etudiants.CPI2], "『🇪🇸』espagnol", cpi2Category, 4, espagnolCpi2Role);
    }
    
    create_complet_category(message, roleEve, roleModo, roleMono, roleEtu[Etudiants.CPI1], "CPI 1");
    create_complet_category(message, roleEve, roleModo, roleMono, roleEtu[Etudiants.MT3], "MT 3");
    create_complet_category(message, roleEve, roleModo, roleMono, roleEtu[Etudiants.IATIC3], "IATIC 3");
    create_complet_category(message, roleEve, roleModo, roleMono, roleEtu[Etudiants.SEE3], "SEE 3");
    create_complet_category(message, roleEve, roleModo, roleMono, roleEtu[Etudiants.SNPI3], "SNPI 3");
    create_complet_category(message, roleEve, roleModo, roleMono, roleEtu[Etudiants.M1CHPS], "M1 CHPS");
    create_complet_category(message, roleEve, roleModo, roleMono, roleEtu[Etudiants.M1IRS], "M1 IRS");

    return true;
}

async function resetpromo(message) {
    if (!message.member.roles.cache.filter(r => r.id !== message.guild.id).find(r => r.name === "Gérant du serv")) {
        return message.reply("non t'as pas le droit toi").then(m => m.delete({ timeout: 5000}));
    }
